...
/*
 * Aqui eu só puxei a classe com o padrão lá, consigo adicionar mais classes e tals, e fica a dica, quando
 */
public class PessoaDAO implements IPessoaDAO {

	
	/*
	 * statement é o carinha onde vc aponta os values ( ? ) basicamente vc executa
	...
	@Override
	public List<Pessoa> buscarId(int id) {
