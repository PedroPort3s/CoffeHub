...
public class PesquisaProdutoController implements Initializable {
		...
		if (PesquisaProduto == null) {
			try {
				...
				AnchorPane root = (AnchorPane) FXMLLoader
						.load(getClass().getResource("/views/Produto/PesquisaProduto.fxml"));
	...
	void ListarProdutos() {
		...
		try {
			lstProdutos = new ControlProduto().ListarCategoriaUnidadeMedida(txtDescricao.getText(),
					cbCategoria.getSelectionModel().getSelectedItem().getCod(), 0);
			if (lstProdutos != null) {
